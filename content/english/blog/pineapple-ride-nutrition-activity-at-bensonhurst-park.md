...
For that reason, each part of the Food Foundations station was designed to work as a short, separate interaction. Someone could complete one activity without needing an introduction to everything else at the table.
...
The goal was not to give every food a single job or divide foods into strict categories. Many foods contain several nutrients, and mixed dishes may include ingredients from more than one food group.
...
The question did not have to be answered by declaring one drink universally good and the other bad. Water is usually a practical choice for ordinary hydration, while sports drinks may have a more specific use during prolonged or demanding physical activity.
...
There was no single correct snack. A person might combine fruit with yogurt, crackers with cheese, or another set of familiar foods. Preferences, allergies, cost, availability, and cultural habits can all affect what makes sense for a particular family.
...
Food labels contain a large amount of information in a small space. A short challenge made it possible to focus on one part at a time rather than explain every number on the label at once.
...
Food Foundations handled its activity materials, setup, facilitation, and cleanup. Keeping the activities short also meant that each explanation needed to be understandable without relying on a long presentation beforehand.
...
Thank you to the Pineapple Ride team for helping coordinate the activity and to the families and community members who stopped at the table. Food Foundations will continue developing nutrition activities that can be adapted to different ages, spaces, and event formats.
